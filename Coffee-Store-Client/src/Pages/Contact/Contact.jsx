  ...
  return (
    <section className="mb-32">
      ...
      <div className="mx-auto container px-6 md:px-12">
        <div className=" block rounded-lg bg-[#F5F5F5] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px] border border-gray-300">
          <div className="flex  gap-16">
            <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
              <form>
                <div className="grid grid-cols-2 relative mb-6">
                  <input
                    type="text"
...
const ContactInfo = ({ title, email, phone, icon }) => {
  return (
